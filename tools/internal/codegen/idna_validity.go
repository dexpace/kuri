...
func generateIdnaValidity() (string, error) {
	...
	return validityRender(markChunks, viramaChunks, joiningChunks, bidiChunks), nil
}
...
// by one newline.
func validityRender(markChunks, viramaChunks, joiningChunks, bidiChunks []string) string {
	lines := []string{
		LicenseHeader,
		"",
